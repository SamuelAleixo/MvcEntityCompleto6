...
namespace MvcEntityCompleto6.Controllers
{
    public class TransporteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Responsavel")] Transporte transporte)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Responsavel")] Transporte transporte)
        {
            if (id != transporte.Id)
            {
                return NotFound();
