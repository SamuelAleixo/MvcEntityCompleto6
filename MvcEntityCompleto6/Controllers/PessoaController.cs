...
namespace MvcEntityCompleto6.Controllers
{
    public class PessoaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Salario,Apelido")] Pessoa pessoa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Salario,Apelido")] Pessoa pessoa)
        {
            if (id != pessoa.Id)
            {
                return NotFound();
